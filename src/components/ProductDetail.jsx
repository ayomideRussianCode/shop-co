...
function ProductDetail() {
  ...
  return (
      ...
      <div className="w-full lg:w-1/2 ">
        <div className="flex flex-col">
          <div className=" mx-4 my-4">
            <img
              className="rounded-xl w-[358px] h-[290px] justify-center"
              src="/main.png"
              alt="main-img"
            />
          </div>
    ...
    //     <div className=" md:w-1/2 px-10 py-10 lg:mx-20 ">
    //       <div className="flex items-center flex-row-reverse overflow-auto gap-4 ">
    //         <div className="">
    //           <img className="rounded-lg" src="/main.png" alt="main" />
    //         </div>
    //         {/* <div className=" w-full flex flex-row lg:flex-col justify-around gap-4 ">
    //           <img
    //             src="/thumb1.png"
    //             alt="thumb"
    //             className="w-40 rounded-lg object-cover "
