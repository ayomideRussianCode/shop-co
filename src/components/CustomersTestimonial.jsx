...
export default function CustomersTestimonial() {
  ...
  return (
    <div>
      <div className="flex justify-between mx-6 lg:mx-14">
        <h1 className="font-IntegralBold text-3xl lg:text-4xl">OUR HAPPY CUSTOMERS</h1>
        <div>
          <button className="flex">
            <GoArrowLeft className="" size={18} />
...
//         <h2 className="text-2xl sm:text-3xl font-IntegralBold">OUR HAPPY CUSTOMERS</h2>
...
function StarIcon({ filled }) {
  return (
    <span className={`text-yellow-400`}>
      {filled ? <FaStar className="w-5 h-5" /> : <FaRegStar className="w-5 h-5 text-gray-300" />}
    </span>
  );
}
